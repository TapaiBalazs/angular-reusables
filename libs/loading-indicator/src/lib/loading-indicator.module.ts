...
@NgModule({
  declarations: [EllipsisComponent, IndicatorHostDirective, LoadingIndicatorComponent, OverlayComponent, SpinnerComponent],
  entryComponents: [SpinnerComponent, EllipsisComponent],
  imports: [CommonModule],
  exports: [EllipsisComponent, LoadingIndicatorComponent, SpinnerComponent],
})
